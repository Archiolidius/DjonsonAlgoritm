...
// Обчислення для 2 одиниць обладнання
    function resolvedForE2() {
        sortT2();
        timeZagal(2);
        $(".hideIf2GVM").hide(0);
        // yakistPok(2);
...
// Фунція сортування деталей в правильному порядку
    function sortT2() {
        ...
        for (var i = 0; i < countDetail; i++) {
            if ( tableTime[i][1]  < tableTime[i][2] ) {
...
//Зворотне сортування двумірного масиву за другим стовбцем
    function sT2(a, b) {
        if (a[2] < b[2] ) return 1;
